    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-dark-300">Find your perfect hackathon teammates</p>
        </motion.div>
        ...
        >
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-sm text-dark-400">OR</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full px-4 py-3 bg-white text-dark-900 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-[#24292F] text-white rounded-lg font-medium hover:bg-[#2c3238] transition-colors flex items-center justify-center gap-2"
            >
