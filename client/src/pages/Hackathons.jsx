    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, padding: '100px 40px 60px', maxWidth: 1300, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(380px, 1fr))', gap: 20 }}>
          {hackathons.map(h => (
            <div key={h.name} style={{ borderRadius: 'var(--radius)', background: 'var(--bg-card)', boxShadow: 'var(--shadow-card)', border: '1px solid rgba(0,0,0,0.04)', overflow: 'hidden', cursor: 'pointer', transition: 'transform 0.3s, box-shadow 0.3s' }}
            ...
            >
              <div style={{ height: 160, position: 'relative', background: h.bannerGrad, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <span style={{ position: 'absolute', top: 14, left: 14, padding: '5px 12px', borderRadius: 10, fontSize: '0.7rem', fontWeight: 600, background: 'rgba(255,255,255,0.9)', color: 'var(--text-dark)' }}>{h.date}</span>
              </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: registered[h.name] ? 'none' : 'var(--shadow-soft)',
                    }}
                  >
